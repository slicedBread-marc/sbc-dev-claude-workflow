...
#
# {{project_slug}} is baked in by install.sh at deploy time from
# claude-workflow.yml. No runtime resolution.
...
echo "COMPOSE_PROJECT_NAME={{project_slug}}-pln${plan_id_padded}"
